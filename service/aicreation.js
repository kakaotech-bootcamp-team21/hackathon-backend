...
function generatePrompt(theme, lesson) {
    const prompt = `Create stories that are appropriate for kids ages 3-5. The main character of the story is '${theme}', and it should teach the lesson of '${lesson}'. make story's max words between 100 to 150. divide story to at least 5 paragraph. Write the story in Korean.`;
    return prompt;
}
