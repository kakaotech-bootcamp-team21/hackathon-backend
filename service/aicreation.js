...
function generatePrompt(theme, lesson) {
    const prompt = `Create stories that are appropriate for kids ages 3-5. The main character of the story is '${theme}', and it should teach the lesson of '${lesson}'. Make sure the story is simple, fun, and age-appropriate. make story's max words between 100 to 150. Write the story in Korean.`;
    return prompt;
}
